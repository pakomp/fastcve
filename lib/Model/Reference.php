...
class Reference implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/^(ftp|http)s?:\/\/\\S+$/", $this->container['url'])) {
            $invalidProperties[] = "invalid value for 'url', must be conform to the pattern /^(ftp|http)s?:\/\/\\S+$/.";
        }
    ...
    public function setUrl($url)
    {
        ...
        if ((mb_strlen($url) > 500)) {
            throw new \InvalidArgumentException('invalid length for $url when calling Reference., must be smaller than or equal to 500.');
        }
        if ((!preg_match("/^(ftp|http)s?:\/\/\\S+$/", ObjectSerializer::toString($url)))) {
            throw new \InvalidArgumentException("invalid value for \$url when calling Reference., must conform to the pattern /^(ftp|http)s?:\/\/\\S+$/.");
        }
