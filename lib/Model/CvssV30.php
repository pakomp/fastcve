 ...
 */
class CvssV30 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CvssV30';
    ...
    protected static $openAPITypes = [
        ...
        'cvss_data' => '\Msn\Apis\FastCVE\Model\CommonModelsCvssV30CveCvssDataModel',
    ...
    */
     ...
     * Gets cvss_data
     *
     * @return \Msn\Apis\FastCVE\Model\CommonModelsCvssV30CveCvssDataModel
     */
     ...
     * Sets cvss_data
     *
     * @param \Msn\Apis\FastCVE\Model\CommonModelsCvssV30CveCvssDataModel $cvss_data cvss_data
     *
     * @return self
     */
    ...
    public function setExploitabilityScore($exploitability_score)
    {
        ...
        if (($exploitability_score > 10.0)) {
            throw new \InvalidArgumentException('invalid value for $exploitability_score when calling CvssV30., must be smaller than or equal to 10.0.');
        }
        if (($exploitability_score < 0.0)) {
            throw new \InvalidArgumentException('invalid value for $exploitability_score when calling CvssV30., must be bigger than or equal to 0.0.');
        }
    ...
    public function setImpactScore($impact_score)
    {
        ...
        if (($impact_score > 10.0)) {
            throw new \InvalidArgumentException('invalid value for $impact_score when calling CvssV30., must be smaller than or equal to 10.0.');
        }
        if (($impact_score < 0.0)) {
            throw new \InvalidArgumentException('invalid value for $impact_score when calling CvssV30., must be bigger than or equal to 0.0.');
        }
